      ...
      <div className="container margen grid">
        <div className="pg-noticia-container">
          ...
          <div className="botones">
            ...
            <div className="fb-share-button" data-href="https://ranatv.herokuapp.com" data-layout="button" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Franatv.herokuapp.com%2F&amp;src=sdkpreparse" className="fb-xfbml-parse-ignore">Compartir</a></div>
          </div>
        </div>
